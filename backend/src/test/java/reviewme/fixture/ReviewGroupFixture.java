...
public class ReviewGroupFixture {
    ...
    public static ReviewGroup 비회원_리뷰_그룹() {
        return 비회원_리뷰_그룹("reviewRequestCode", "groupAccessCode");
    }

    public static ReviewGroup 회원_리뷰_그룹() {
        return new ReviewGroup(1L, 1L, "reviewee", "project", "requestCode");
    }

    public static ReviewGroup 회원_지정_리뷰_그룹(long memberId) {
        return new ReviewGroup(memberId, 1L, "reviewee", "project", "requestCode");
    }
}

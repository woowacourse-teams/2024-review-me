...
class OptionItemRepositoryTest {
    ...
    void 리뷰_아이디와_옵션_타입으로_선택한_옵션_아이템을_불러온다() {
        ...
        Question question1 = questionRepository.save(new Question(true, QuestionType.CHECKBOX,
                "프로젝트 기간 동안, 팀원의 강점이 드러났던 순간을 선택해주세요. (1~2개)", null, 1));
        Question question2 = questionRepository.save(new Question(true, QuestionType.CHECKBOX,
        ...
        // when
        List<OptionItem> optionItems = optionItemRepository.findByReviewIdAndOptionType(

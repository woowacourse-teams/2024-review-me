...
class TemplateServiceTest {
    ...
    void 잘못된_리뷰_요청_코드로_리뷰_작성폼을_요청할_경우_예외가_발생한다() {
        ...
        // when, then
        String wrongReviewRequestCode = "wrong" + savedReviewGroup.getReviewRequestCode();
        assertThatThrownBy(() -> templateService.generateReviewForm(wrongReviewRequestCode))
    ...
    void 리뷰이에게_작성될_리뷰_양식_생성_시_저장된_템플릿이_없을_경우_예외가_발생한다() {
        ...
        // when, then
        assertThatThrownBy(() -> templateService.generateReviewForm(savedReviewGroup.getReviewRequestCode()))

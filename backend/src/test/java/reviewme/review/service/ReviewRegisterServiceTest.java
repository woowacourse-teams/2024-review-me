...
class ReviewRegisterServiceTest {
    ...
    void 요청한_내용으로_리뷰를_등록한다() {
        ...
        assertAll(
                () -> assertThat(review.getTypeAnswers(TextAnswer.class)).extracting(TextAnswer::getQuestionId)
                        .containsExactly(requiredTextQuestion.getId()),
                () -> assertThat(review.getTypeAnswers(CheckboxAnswer.class)).extracting(CheckboxAnswer::getQuestionId)

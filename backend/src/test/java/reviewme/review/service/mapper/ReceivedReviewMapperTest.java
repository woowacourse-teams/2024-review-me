...
@ServiceTest
class ReceivedReviewMapperTest {

    @Autowired
    private ReceivedReviewMapper reviewMapper;
    ...
    @Test
    void 리뷰_목록을_내가_받은_리뷰_목록으로_매핑한다() {
        // given
        long memberId = 1L;
        ...
        // when
        List<ReceivedReviewPageElementResponse> responses = reviewMapper.mapToReviewList(List.of(review1, review2, review3));

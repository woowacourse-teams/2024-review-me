...
@Slf4j
public class SectionInTemplateNotFoundException extends DataConsistencyException {

    public SectionInTemplateNotFoundException(long templateId, long sectionId) {
        super("서버 내부에서 문제가 발생했어요. 서버에 문의해주세요.");
        log.warn("SectionNotFoundException is occurred - templateId: {}, sectionId: {}", templateId, sectionId);
    }
}
